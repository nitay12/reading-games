...
const SLIDES: Slide[] = [
  {
    ...
    body: (
      <>
        ...
        <p>
          הַיֶּלֶד מִתְקַדֵּם דֶּרֶךְ <b>5 רָמוֹת נִקּוּד</b> (מִקָּמָץ עַד שׁוּרוּק)
          וּ-<b>4 רָמוֹת מוּרְכָּבוּת</b> (מֵהֲבָרָה אַחַת עַד מִשְׁפָּטִים).
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        <p>
          ...
          בֵּיצָה, סְלַיים, נָחָשׁ, זוֹחֵל, דַּיְנוֹ, וְלִבְסוֹף <b>דְּרָקוֹן אַדִּיר</b>.
        </p>
